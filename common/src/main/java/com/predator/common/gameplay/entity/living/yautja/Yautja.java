    ...
    public @Nullable SpawnGroupData finalizeSpawn(
        ...
        if (random.nextDouble() <= 0.5) {
            if (random.nextDouble() <= 0.7) {
                setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(PredatorItems.SHURIKEN.get()));
            } else {
                setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(PredatorItems.SMART_DISC.get()));
            }
        }
